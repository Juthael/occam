...
public class ProductionTest {
	...
	private IIntentConstruct constr1 = new IntentConstruct(new Construct(prog1), new Concept(mockIntent1, mockExtent1));
	private IIntentConstruct constr2 = new IntentConstruct(new Construct(prog2), new Concept(mockIntent2, mockExtent2));
	private IIntentConstruct constr3 = new IntentConstruct(new Construct(prog3), new Concept(mockIntent3, mockExtent3));
	private IIntentConstruct constr4 = new IntentConstruct(new Construct(prog4), new Concept(mockIntent4, mockExtent4));
