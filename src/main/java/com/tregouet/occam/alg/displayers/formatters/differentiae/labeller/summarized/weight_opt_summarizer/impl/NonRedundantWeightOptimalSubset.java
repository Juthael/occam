package com.tregouet.occam.alg.displayers.formatters.differentiae.labeller.summarized.weight_opt_summarizer.impl;
...
public class NonRedundantWeightOptimalSubset implements DifferentiaeWeightOptSummarizer {
	...
	public static final NonRedundantWeightOptimalSubset INSTANCE = new NonRedundantWeightOptimalSubset();
	private static final MathContext mathContext = new MathContext(3);

	private NonRedundantWeightOptimalSubset() {
	}
