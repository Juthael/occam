package com.tregouet.occam.data.structures.automata;

import java.util.Collection;
import java.util.Map;
import java.util.Set;

import com.tregouet.occam.data.structures.automata.states.IState;
import com.tregouet.occam.data.structures.automata.transition_functions.ITransitionFunction;
import com.tregouet.occam.data.structures.automata.transition_functions.transitions.ITransition;
import com.tregouet.occam.data.structures.automata.transition_functions.transitions.input_config.IInputConfiguration;
import com.tregouet.occam.data.structures.automata.transition_functions.transitions.output_config.IOutputInternConfiguration;
