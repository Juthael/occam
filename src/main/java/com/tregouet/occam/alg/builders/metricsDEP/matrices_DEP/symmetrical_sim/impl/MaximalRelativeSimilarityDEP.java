package com.tregouet.occam.alg.builders.metricsDEP.matrices_DEP.symmetrical_sim.impl;

import org.jgrapht.graph.DirectedAcyclicGraph;

import com.tregouet.occam.alg.builders.metricsDEP.matrices_DEP.symmetrical_sim.SimilarityMatrixBuilderDEP;
import com.tregouet.occam.alg.builders.metricsDEP.matrices_DEP.symmetrical_sim.impl.utils.References;
import com.tregouet.occam.data.modules.categorization.transitions.AProblemStateTransition;
import com.tregouet.occam.data.representations.IRepresentation;

public class MaximalRelativeSimilarityDEP implements SimilarityMatrixBuilderDEP {
	...
	public MaximalRelativeSimilarityDEP() {
	}
	...
	@Override
	public SimilarityMatrixBuilderDEP setUp(int nbOfParticulars,
		...
		for (IRepresentation representation : problemGraph.vertexSet()) {
			double[][] relativeSimilarityMatrix = representation.getSimilarityMatrixDEP();
