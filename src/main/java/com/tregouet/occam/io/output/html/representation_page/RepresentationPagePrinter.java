...
public class RepresentationPagePrinter {
	...
	private static String printGeneralDescription(List<IContextObject> objects, IRepresentation representation, String alinea) {
		StringBuilder sB = new StringBuilder();
		...
		sB.append(alineaa + "<section>" + nL)
			...
			.append(printTypicalityVector(objects, representation, alineaaa))
			.append(alineaa + "</section>");
		return sB.toString();
	}
	...
	private static String printClassificationTree(IRepresentation representation, String alinea) {
		String figureFullPath = 
				VisualizersAbstractFactory.INSTANCE.getConceptGraphViz().apply(
						representation.getTreeOfConcepts(), "classification_tree");
		StringBuilder sB = new StringBuilder();
		String alineaa = alinea + "   ";
		String alineaaa = alineaa + "   ";
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> CLASSIFICATION TREE </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
	...
	private static String printContext(List<IContextObject> objects, String alinea) {
		...
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> CONTEXT </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
	...
	private static String printDescription(IRepresentation representation, String alinea) {
		String figureFullPath = 
				VisualizersAbstractFactory.INSTANCE.getDescriptionViz().apply(representation.getDescription(), "description");
		StringBuilder sB = new StringBuilder();
		String alineaa = alinea + "   ";
		String alineaaa = alineaa + "   ";
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> GENUS/DIFFERENTIAE DESCRIPTION </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
		 .append(FigurePrinter.INSTANCE.displayFigure(figureFullPath, alineaaa, "Genus/Differentiae description") + nL)
		 .append(alinea  + "</section>" + nL);
		return sB.toString();		
	}
	
	private static String printSimilarityMatrix(List<IContextObject> objects, IRepresentation representation, String alinea) {
		...
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> SIMILARITY MATRIX </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
	...
	private static String printAsymetricalSimilarityMatrix(List<IContextObject> objects, 
			IRepresentation representation, String alinea) {
		String[] head = new String[objects.size()];
		int idx = 0;
		for (IContextObject obj : objects)
			head[idx++] = Integer.toString(obj.getID());
		...
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> ASYMMETRICAL SIMILARITY MATRIX </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
		 .append(TablePrinter.INSTANCE.print2DSquareTable(head, matrix, "Asymmetrical similarity matrix", alineaaa) + nL)
		 .append(alinea  + "</section>" + nL);
		return sB.toString();
	}
	
	private static String printTypicalityVector(List<IContextObject> objects, 
			IRepresentation representation, String alinea) {
		String[] head = new String[objects.size()];
		int idx = 0;
		for (IContextObject obj : objects)
		...
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> TYPICALITY VECTOR </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
	...
	private static String printAutomatonGraph(IRepresentation representation, String alinea) {
		String figureFullPath = 
				VisualizersAbstractFactory.INSTANCE.getTransitionFunctionViz().apply(
						representation.getTransitionFunction(), "trans_func");
		StringBuilder sB = new StringBuilder();
		String alineaa = alinea + "   ";
		String alineaaa = alineaa + "   ";
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> AUTOMATON TRANSITION FUNCTION </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
		 .append(FigurePrinter.INSTANCE.displayFigure(figureFullPath, alineaaa, "Automaton transition function") + nL)
		 .append(alinea  + "</section>" + nL);
		return sB.toString();	
	}
	...
	private static String printAcceptedFacts(IRepresentation representation, String alinea) {
		...
		sB.append(alinea  + "<section>" + nL)
		 .append(alineaa  + "<header>" + nL)
		 .append(alineaaa + "<h3> ACCEPTED FACTS </h3>" + nL)
		 .append(alineaa  + "</header>" + nL)
		 .append(TablePrinter.INSTANCE.printStringTableWithOptionalSubHead(head, null, facts, "Accepted facts", alineaaa) + nL)
		 .append(alinea  + "</section>" + nL);
		return sB.toString();	
	}
