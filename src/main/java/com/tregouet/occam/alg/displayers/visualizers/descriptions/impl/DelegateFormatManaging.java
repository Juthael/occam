...
public class DelegateFormatManaging implements DescriptionViz {
	...
	@Override
	public DescriptionViz setUp(Map<Integer, List<Integer>> conceptID2ExtentIDs, DescriptionFormat format) {
