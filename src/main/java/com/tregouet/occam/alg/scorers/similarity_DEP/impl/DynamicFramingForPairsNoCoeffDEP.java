...
public class DynamicFramingForPairsNoCoeffDEP extends RelativeAbstractSimilarityScorerDEP
		implements RelativePairSimilarityScorerDEP {
	...
	@Override
	public RelativePairSimilarityScorerDEP setAsContext(Tree<Integer, ADifferentiae> classificationTree) {
