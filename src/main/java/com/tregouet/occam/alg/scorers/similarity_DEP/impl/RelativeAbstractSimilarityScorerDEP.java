...
import com.tregouet.occam.alg.scorers.similarity_DEP.RelativeSimilarityScorerDEP;
import com.tregouet.occam.data.representations.descriptions.differentiae.ADifferentiae;
import com.tregouet.tree_finder.data.Tree;

public abstract class RelativeAbstractSimilarityScorerDEP implements RelativeSimilarityScorerDEP {

	protected Tree<Integer, ADifferentiae> classificationTree;

	public RelativeAbstractSimilarityScorerDEP() {
	}
