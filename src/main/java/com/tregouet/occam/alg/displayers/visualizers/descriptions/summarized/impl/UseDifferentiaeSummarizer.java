package com.tregouet.occam.alg.displayers.visualizers.descriptions.summarized.impl;
...
public class UseDifferentiaeSummarizer implements SummarizedDescriptionViz {
	
	public static final UseDifferentiaeSummarizer INSTANCE = new UseDifferentiaeSummarizer();
	
	private UseDifferentiaeSummarizer() {
	}
	
	@Override
	public String apply(IDescription description, String fileName) {
		DifferentiaeSummarizer diffSummarizer = SummarizedDescriptionViz.differentiaeSummarizer();
